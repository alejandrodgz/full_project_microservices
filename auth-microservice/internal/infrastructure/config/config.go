...
type ExternalAPIConfig struct {
	CitizenValidationURL    string
	CitizenValidationAPIKey string
...
func Load() (*Config, error) {
	...
	config := &Config{
		...
		ExternalAPI: ExternalAPIConfig{
			CitizenValidationURL:    getEnv("EXTERNAL_CITIZEN_VALIDATION_URL", "https://govcarpeta-apis-4905ff3c005b.herokuapp.com"),
			CitizenValidationAPIKey: getEnv("EXTERNAL_CITIZEN_VALIDATION_API_KEY", ""),
			EnableValidation:        getEnv("ENABLE_CITIZEN_VALIDATION", "true") == "true",
		},
	}
