...
class DocumentAuthentication(models.Model):
    ...
    # Event tracking fields (from Documents microservice)
    message_id = models.CharField(max_length=100, blank=True, default='', help_text="Message ID for deduplication")
    document_id = models.CharField(max_length=100, blank=True, default='', db_index=True, help_text="Document ID from Documents microservice")
